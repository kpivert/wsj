...
# ggsave(
#   filename = "05_choropleth/first_take_3.png",
#   width = 3,
#   height = 4,
#   units = "in",
#   dpi = 300
...
# ggsave(
#   filename = "05_choropleth/third_take_R2.png",
#   width = 3, 
#   height = 3.25,
#   units = "in",
#   dpi = 300
...
((zero_na_legend + theme(plot.margin = unit(c(0,30,0,30), "pt")))  + top_legend) /
  a +
  plot_annotation(
    title = "Federal Medicaid funding from hospital & nursing-\nhome taxes, forecast for fiscal year 2026, %"
  ) &
...
((zero_na_legend + theme(plot.margin = unit(c(0,30,0,30), "pt"))) + top_legend) /
  a +
  plot_layout(heights = c(0.2, 1)) +  # Legend gets 0.2, main plot gets 1
  plot_annotation(
    title = "Federal Medicaid funding from hospital & nursing-\nhome taxes, forecast for fiscal year 2026, %"
  ) &
  theme(
...
ggsave(
  filename = "05_choropleth/fourth_take_R1.png",
  width = 3, 
  height = 3.25,
  units = "in",
  dpi = 300
...
((zero_na_legend + theme(plot.margin = unit(c(0,30,0,30), "pt"))) + top_legend) /
  a +
  plot_layout(heights = c(0.05, 1)) +  # Legend gets 0.2, main plot gets 1
  plot_annotation(
    title = "Federal Medicaid funding from hospital & nursing-\nhome taxes, forecast for fiscal year 2026, %"
  ) &
  theme(
...
# ggsave(
#   filename = "05_choropleth/fourth_take_R2.png",
#   width = 3, 
#   height = 3.25,
#   units = "in",
#   dpi = 300
...
((zero_na_legend + 
    coord_fixed(ratio = 1) +
    theme(plot.margin = unit(c(0, 10, 0, 50), "pt"))) + 
  (top_legend + 
    theme(plot.margin = unit(c(0, 50, 0, 10), "pt")))) /
  a +
...
# ggsave(
#   filename = "05_choropleth/fourth_take_R3.png",
#   width = 3, 
#   height = 3,
#   units = "in",
#   dpi = 300
...
ggsave(
  filename = "05_choropleth/fourth_take_R4.png",
  width = 3, 
  height = 3,
  units = "in",
  dpi = 300
...
((zero_na_legend + 
    coord_fixed(ratio = 1) +
    theme(plot.margin = unit(c(0, 10, -5, 50), "pt"))) + 
  (top_legend + 
    theme(plot.margin = unit(c(0, 50, -5, 10), "pt")))) /
  (a +
...
ggsave(
  filename = "05_choropleth/fourth_take_R5.png",
  width = 2, 
  height = 2.1,
  units = "in",
  dpi = 300
